...
class ContactService {
    static create(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createRequest = validation_helper_1.validation.validate(contact_validation_1.ContactValidation.CREATE, request);
    ...
    static checkIfContactExist(username, contactId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static get(user, id) {
        return __awaiter(this, void 0, void 0, function* () {
            const contact = yield this.checkIfContactExist(user.username, id);
            return (0, contact_model_1.toContactResponse)(contact);
        });
    }
    static update(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateRequest = validation_helper_1.validation.validate(contact_validation_1.ContactValidation.UPDATE, request);
            yield this.checkIfContactExist(user.username, updateRequest.id);
    ...
    static remove(user, id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.checkIfContactExist(user.username, id);
    ...
    static search(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const searchRequest = validation_helper_1.validation.validate(contact_validation_1.ContactValidation.SEARCH, request);
